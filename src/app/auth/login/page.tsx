          ...
          <div className='grid md:grid-cols-2'>
            <div className="hidden md:flex flex-col items-center justify-center">
              <div className="flex flex-col mx-10">
                <h1 className="text-5xl text-balance !leading-tight font-bold tracking-tight w-[95%]">
                  Log In To <span className="bg-[#6C48C5] text-white px-2 pb-1 rounded-xl">Manage</span> Awesome Stuff.
                </h1>
                <h1 className="text-md font-semibold tracking-tight mt-7 w-[60%]">
                  If you don&lsquo;t have an account <span><Backlink text="register here!" href="/auth/register"></Backlink></span>
                </h1>
              </div>
            </div>
            <div className="mt-[3rem] md:mt-0 md:mx-20">
              <h1 className="md:text-5xl text-3xl font-bold text-black text-balance tracking-tight text-center md:hidden !leading-tight">Log In to <span className="bg-[#6C48C5] text-white px-2 pb-1 rounded-xl">Manage</span> Awesome Stuff!</h1>
              <LoginForm></LoginForm>
            </div>
          </div>
        </div>
